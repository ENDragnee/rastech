    ...
    <div className="space-y-4 sm:space-y-5 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="w-full sm:w-80 relative">
          ...
          <Input
            type="text"
            placeholder="Search invoice #, customer, SN..."
            value={search}
            onChange={(e) => {
      ...
      <div className="flex gap-1.5 overflow-x-auto pb-1 max-w-full text-xs scrollbar-none">
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg font-medium whitespace-nowrap transition-colors ${typeFilter === "SOLD"
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg font-medium whitespace-nowrap transition-colors ${typeFilter === "RETURNED"
